    ...
    return (
        <section className='h-[100vh] flex flex-col justify-center items-center bg-[#FFF8DC] px-6'>
            <div className='max-w-md w-full bg-white p-8 rounded-lg shadow-lg'>
                ...
                <h3 className='text-xl font-semibold text-gray-700 mb-6 text-center'>Create an account</h3>
                ...
                <form className='flex flex-col gap-y-6 rounded-lg'>
                    ...
                    <button
                        type='submit'
                        className='bg-[#8B4513] text-white py-3 rounded-lg text-lg font-bold hover:bg-[rgb(255,186,39)] transition-all duration-300'
                    >
                        <Link to="/student-login">Sign Up</Link>
                    </button>
                </form>
            ...
            <Link to="/student-login" className=''>Log In</Link>
            </div>
        </section>
    );
};
